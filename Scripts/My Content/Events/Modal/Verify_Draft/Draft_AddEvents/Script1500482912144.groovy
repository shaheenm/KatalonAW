...
WebUI.setText(findTestObject('Page_Events  Advisor Websites/input_field_location0value'), Location)

WebUI.setText(findTestObject('Page_Events  Advisor Websites/input_field_date_to0valuedate'), a)
