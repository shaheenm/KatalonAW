...
WebUI.callTestCase(findTestCase('My Content/Blogs/Modal/No Images/Verify_Send_to_review/Send_to_review_Add_blogs'), [('Title') : 'Test Blog Send to Review 1'
        , ('Text') : 'This page is directly sent to review', ('Tags') : 'ItemPub1'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Page_Blogs junetest2bda/input_field_tagstarget_id_Tags'), GlobalVariable.Tags[2])
...
WebUI.verifyTextPresent(GlobalVariable.Tags[2], true)
...
not_run: WebUI.verifyTextPresent(Title + (GlobalVariable.AddDraftTitle[5]), true)
