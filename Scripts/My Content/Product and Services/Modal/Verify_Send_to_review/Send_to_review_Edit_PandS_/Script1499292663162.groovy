...
WebUI.uncheck(findTestObject('Page_Products  Services  junetest2b/input_field_link_to_pagevalue_Checkbox'))
...
WebUI.verifyMatch(actual_title, 'TEST PRODUCT SEND TO REVIEW EDIT 1', true)
